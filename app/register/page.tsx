    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full">
        ...
        <Link href="/" className="flex items-center justify-center space-x-2 mb-8">
          ...
          <span className="text-2xl font-bold text-slate-900">StudyTracker</span>
        </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">Start tracking your study sessions today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start">
              <input
                type="checkbox"
                required
                className="h-4 w-4 text-blue-600 rounded border-slate-300 mt-1"
              />
